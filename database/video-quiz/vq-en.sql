...
insert into Quizzes(video, question, answers) values(
       4,
       'Why do I need to take 4 different medications?',
...
insert into Quizzes(video, question, answers) values(
       4,
       'Why do I need take the antibiotics?',
       'All of the other answers:To get rid of symptoms:To attack the tuberculosis bacteria:To have more energy'
);
...
insert into Quizzes(video, question, answers) values(
       ...
       'All of the other answers:Not all the bacteria get killed:The bacteria can get immune for the medication'
);
